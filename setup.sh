...
FIREBASE_SDK_FILE="firebase-sdk.zip"
...
SIMPLE_LOGIN_SDK_FILE="simple-login-sdk.zip"
...
download_sdk "Firebase SDK" "$FIREBASE_SDK_URL" "$FIREBASE_SDK_FILE"
download_sdk "Firebase Simple Login SDK" "$SIMPLE_LOGIN_SDK_URL" "$SIMPLE_LOGIN_SDK_FILE"
download_sdk "Google+ SDK" "$GOOGLE_SDK_URL" "$GOOGLE_SDK_FILE"

download_sdk "Facebook SDK" "$FACEBOOK_SDK_URL" "$FACEBOOK_SDK_FILE"
